/**
 * @source https://github.com/ChromeDevTools/devtools-frontend/blob/67040db57f3c2f9763d8cda8ee50a825e5d8478e/extension-api/ExtensionAPI.d.ts
 */
...
export namespace Chrome {
  export namespace DevTools {
    ...
    export interface Resource {
      ...
      getContent(
        callback: (content: string, encoding: string) => unknown
      ): void;
      setContent(
        content: string,
        commit: boolean,
    ...
    export interface InspectedWindow {
      ...
      onResourceContentCommitted: EventSink<
        (resource: Resource, content: string) => unknown
      >;
    ...
    export interface PanelWithSidebar {
      createSidebarPane(
        title: string,
        callback?: (result: ExtensionSidebarPane) => unknown
      ): void;
    ...
    export interface Panels {
      ...
      create(
        ...
        iconPath: string,
        pagePath: string,
        callback?: (panel: ExtensionPanel) => unknown
      ): void;
      openResource(
        url: string,
        lineNumber: number,
    ...
    export interface LanguageExtensionPlugin {
      ...
      getFunctionInfo(
        ...
        | { frames: Array<FunctionInfo>; missingSymbolFiles: Array<string> }
    ...
    export interface LanguageExtensions {
      registerLanguageExtensionPlugin(
        plugin: LanguageExtensionPlugin,
        pluginName: string,
        supportedScriptTypes: SupportedScriptTypes
      ): Promise<void>;
      unregisterLanguageExtensionPlugin(
        plugin: LanguageExtensionPlugin
      ): Promise<void>;
    ...
    export interface RecorderExtensions {
      ...
      unregisterRecorderExtensionPlugin(
        plugin: RecorderExtensionPlugin
      ): Promise<void>;
